class DataValidation{
    ...
    validateData = () => {
        ...
        if(this.property.inputType === "string" || this.property.inputType === "number"){
            if(!this.property.canBeEmpty && value === ""){
                ...
                valuesArray.forEach(value => {
                    ...
                    if(this.property.varType.includes(valueType) && valueType !== "object"){
                        ...
                        validSummary.isValid = false
                        validSummary.errorMessage = `Wartość tego pola posiada zły typ! Dozwolone typy dla tego pola to: ${configObject.varType.join(", ")}`
                        return validSummary
                    }
                })
            }
